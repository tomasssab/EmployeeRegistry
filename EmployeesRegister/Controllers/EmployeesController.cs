...
namespace EmployeesRegister.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Sport([Bind(Prefix="department")]string department)
        {
            var model = db.Employees.Where(i => i.Department == department).ToList();
            return View(model);
        }


        public ActionResult PositionFilter([Bind(Prefix = "position")]string position)
        {
            var model = db.Employees.Where(i => i.Position == position).ToList();
            return View(model);
        }
